...
void Render::window() {
    ...
    font = LoadFontEx("assets/FreeSans.otf", 42, NULL, 0);
...
void Render::mainGridMouse() {
    ...
    if (selectedPiece->validmove(row, col)) {
        ...
        //execute special moves independednt of standard capturing
        ...
        //en passant availability window creation
...
void Render::promotionMouse(float offsetX, float OffsetY, float popupCell) {
    ...
    switch (choice) {
    case 0: board[promotionCord.row][promotionCord.col] = new Rook(promotionColor, promotionCord.row, promotionCord.col); break;
    case 1: board[promotionCord.row][promotionCord.col] = new Knight(promotionColor, promotionCord.row, promotionCord.col); break;
    case 2: board[promotionCord.row][promotionCord.col] = new Bishop(promotionColor, promotionCord.row, promotionCord.col); break;
    case 3: board[promotionCord.row][promotionCord.col] = new Queen(promotionColor, promotionCord.row, promotionCord.col); break;
    }
